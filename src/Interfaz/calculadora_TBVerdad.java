 ...
 * @author Daniel Arias
 */
public class calculadora_TBVerdad extends javax.swing.JFrame {

    private tablas t;
    private String TXTentrada;

    public calculadora_TBVerdad(String cadena) {
        TXTentrada = cadena;
        initComponents();
        detallesFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calculadora_TBVerdad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calculadora_TBVerdad("").setVisible(true);
            }
        });
    }
